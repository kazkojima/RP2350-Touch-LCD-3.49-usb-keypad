...
struct TouchKey touch_keys[] = { // map touch area to keycode
    ...
    {KEYAREAX(PX(6)+20,PY(1)+20,KEYSIZEX+10,KEYSIZEY+30), HID_KEY_ENTER, LV_SYMBOL_NEW_LINE},
    {KEYAREAX(PX(6)+20,PY(0)+10,KEYSIZEX+10,KEYSIZEY+10), HID_KEY_BACKSPACE, LV_SYMBOL_BACKSPACE},
};
#else
#define KEYSIZE0 60
